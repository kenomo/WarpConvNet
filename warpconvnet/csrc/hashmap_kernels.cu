...
template<typename HashFuncT>
__global__ void insert_kernel_templated(int* table_kvs, const int* vector_keys, int num_keys, int key_dim, int table_capacity) {
...
template<typename HashFuncT>
__global__ void search_kernel_templated(
    ...
    results[idx] = search_hash_table<HashFuncT>(
        table_kvs, vector_keys, query_key, key_dim, table_capacity
    );
}
...
// Insert Wrappers
extern "C" __global__ void insert_kernel_fnv1a(int* table_kvs, const int* vector_keys, int num_keys, int key_dim, int table_capacity) {
    insert_kernel_templated<FNV1AHash>(table_kvs, vector_keys, num_keys, key_dim, table_capacity);
}
extern "C" __global__ void insert_kernel_city(int* table_kvs, const int* vector_keys, int num_keys, int key_dim, int table_capacity) {
    insert_kernel_templated<CityHash>(table_kvs, vector_keys, num_keys, key_dim, table_capacity);
}
extern "C" __global__ void insert_kernel_murmur(int* table_kvs, const int* vector_keys, int num_keys, int key_dim, int table_capacity) {
    insert_kernel_templated<MurmurHash>(table_kvs, vector_keys, num_keys, key_dim, table_capacity);
}

// Search Wrappers
extern "C" __global__ void search_kernel_fnv1a(const int* table_kvs, const int* vector_keys, const int* search_keys, int* results, int num_search_keys, int key_dim, int table_capacity) {
    search_kernel_templated<FNV1AHash>(table_kvs, vector_keys, search_keys, results, num_search_keys, key_dim, table_capacity);
}
extern "C" __global__ void search_kernel_city(const int* table_kvs, const int* vector_keys, const int* search_keys, int* results, int num_search_keys, int key_dim, int table_capacity) {
    search_kernel_templated<CityHash>(table_kvs, vector_keys, search_keys, results, num_search_keys, key_dim, table_capacity);
}
extern "C" __global__ void search_kernel_murmur(const int* table_kvs, const int* vector_keys, const int* search_keys, int* results, int num_search_keys, int key_dim, int table_capacity) {
    search_kernel_templated<MurmurHash>(table_kvs, vector_keys, search_keys, results, num_search_keys, key_dim, table_capacity);
}
