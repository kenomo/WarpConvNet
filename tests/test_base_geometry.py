...
from warpconvnet.geometry.base_geometry import CatBatchedFeatures, CatPatchedFeatures
...
class TestBaseGeometry(unittest.TestCase):
    def setUp(self):
        ...
        self.cat_features = CatBatchedFeatures(
    ...
    def test_cat_to_patch(self):
        patch_features = CatPatchedFeatures.from_cat(self.cat_features, self.patch_size)
        ...
        self.assertTrue(
            (cat_features.batched_tensor == self.cat_features.batched_tensor).all()
        )
